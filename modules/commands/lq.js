...
module.exports.run = async function({ api, args, event, permssion }) {
  ...
  if (!i && event.type == 'message_reply') {
    ...
    return api.sendMessage('Reply tin nhắn để nhập tên ingame của bạn', event.threadID, (err, info) => {
  ...
  if (event.senderID != handleReply.author) return api.sendMessage("Nó làm đéo phải mày làm", event.threadID, event.messageID); 
