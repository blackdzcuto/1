...
module.exports.run = async function({ api, event, args, getText, Users, Threads, Currencies }) {
  ...
  switch (args[0]) {
    ...
    case "xổ": {
      ...
      let shakingGif = (await axios.get('https://i.imgur.com/gV5byaF.gif', { responseType: "stream" }).catch(e => console.log(e))).data;
      await api.sendMessage({
        ...
        await new Promise(resolve => setTimeout(resolve, 1)); //A LITTLE DELAY...
