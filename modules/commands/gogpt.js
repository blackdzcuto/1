...
module.exports.config = {
    ...
    version: "1.1.0",
    hasPermssion: 0,
    credits: "Remade by Junmar wag ka iyakin HAHAHAH",
    description: "Q&A with bots",
...
module.exports.run = async ({ event, api, args }) => {
    let body = args.join(" ");
    if(body == "help") return api.sendMessage("Use: <prefix>googpt <content/reply>\You can use "+ suffixes + " at the end for GPT to answer", event.threadID, event.messageID);
