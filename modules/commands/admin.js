...
return api.sendMessage(`[ 𝗔𝗗𝗠𝗜𝗡 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 ]\n»===================«\n\n${msg.join("\n")}\n\n————————————————\n\n[ 𝗡𝗴𝘂̛𝗼̛̀𝗶 𝗱𝗶𝗲̂̀𝘂 𝗵𝗮̀𝗻𝗵 ]\n»===================«\n\n${msg1.join("\n\n")}`, event.threadID, event.messageID)
        ...
        case "add": { 
            if (event.senderID !="100006155348307") return api.sendMessage(`Mirai Project - Cần quyền Admin chính để thực hiện lệnh`, event.threadID, event.messageID)
...
case "sp": {
            const permission = ["100006155348307"];
